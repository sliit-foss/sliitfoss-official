  ...
  return (
    <section className="h-screen relative">
      <div className="relative h-full grid content-center-safe z-40">
        <h1 className="grid justify-center font-bold text-9xl font-sans mt-30 text-transparent bg-clip-text bg-gradient-to-r from-white to-[#0094BE]">
          SLIIT FOSS
        </h1>
        ...
        <div className="flex justify-center gap-[10px] mt-10">
          <button className="cursor-pointer rounded-3xl py-[12px] px-[20px] shadow-[0_1px_4px_rgba(3,129,165,0.40)] text-[#30839B]">
            Become a member
          </button>
          <button className="cursor-pointer rounded-3xl py-[12px] px-[20px] bg-gradient-to-r from-[#39ACCD] to-[#3FAECE] text-white">
            Become a member
          </button>
        </div>
        <h1 className="grid justify-center font-bold text-9xl font-sans text-transparent bg-clip-text bg-gradient-to-r from-[#F9FDFF] to-[#0094BE] tracking-widest self-end-safe">
          community
        </h1>
      </div>
