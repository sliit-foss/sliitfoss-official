...
export const EventCard = memo(
  ({
    ...
    return (
      <div
        className="relative w-[300px] h-[400px] rounded-xl overflow-hidden shadow-lg flex-shrink-0 bg-black bg-center bg-contain bg-no-repeat"
        style={{
          backgroundImage: 'url(/logo/logo-light.webp)',
